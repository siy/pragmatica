...
public interface ListenConfig<T extends InetAddress> {
    ...
    /**
     * Flags for {@link Proactor#listen(BiConsumer, SocketAddress, SocketType, Set, SizeT, Set)} API call.
     */
    ...
    /**
     * Socket options for {@link Proactor#listen(BiConsumer, SocketAddress, SocketType, Set, SizeT, Set)} API call.
     */
