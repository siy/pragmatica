...
public final class UnsafeRefArrayAccess
{
    ...
    {
        UNSAFE.putReference(buffer, offset, e);
    }
    ...
    {
        UNSAFE.putReferenceRelease(buffer, offset, e);
    }
    ...
    {
        return (E) UNSAFE.getReference(buffer, offset);
    }
    ...
    {
        return (E) UNSAFE.getReferenceVolatile(buffer, offset);
    }
