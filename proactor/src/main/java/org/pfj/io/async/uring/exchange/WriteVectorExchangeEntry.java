...
import static org.pfj.io.async.uring.AsyncOperation.IORING_OP_WRITEV;
...
public class WriteVectorExchangeEntry extends AbstractExchangeEntry<WriteVectorExchangeEntry, SizeT> {
    ...
    public WriteVectorExchangeEntry prepare(final BiConsumer<Result<SizeT>, Proactor> completion,
