...
import org.pfj.io.uring.struct.shape.StatxOffsets;

import static org.pfj.io.async.file.stat.DeviceId.deviceId;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_atime;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_attributes;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_attributes_mask;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_blksize;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_blocks;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_btime;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_ctime;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_dev_major;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_dev_minor;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_gid;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_ino;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_mask;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_mode;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_mtime;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_nlink;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_rdev_major;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_rdev_minor;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_size;
import static org.pfj.io.uring.struct.shape.StatxOffsets.stx_uid;
