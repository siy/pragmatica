...
public interface IoUringSQOffsets {
    ...
    RawProperty kdropped = RawProperty.raw(40, 8);
    RawProperty array = RawProperty.raw(48, 8);
    RawProperty sqes = RawProperty.raw(56, 8);
    RawProperty sqe_head = RawProperty.raw(64, 4);
    RawProperty sqe_tail = RawProperty.raw(68, 4);
    RawProperty ring_sz = RawProperty.raw(72, 8);
    RawProperty ring_ptr = RawProperty.raw(80, 8);
}
