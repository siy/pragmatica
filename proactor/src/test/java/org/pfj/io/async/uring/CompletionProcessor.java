...
class CompletionProcessor implements AutoCloseable {
    ...
    public void process(final long baseAddress, final Consumer<CompletionQueueEntry> consumer) {
        long ready = UringNative.peekCQ(baseAddress, completionBuffer, size);
